...
@PIPELINES.register_module()
class NuScenesPointSegClassMapping(object):

    MAP = [
        16., 16.,  6.,  6.,  6., 16.,  6., 16., 16.,  0., 16., 16.,  7.,
        16.,  1.,  2.,  2.,  3.,  4., 16., 16.,  5.,  8.,  9., 10., 11.,
        12., 13., 14., 16., 15., 16.
    ]
    ...
    def __init__(self):
        self.cat_id2class = np.array(self.MAP, dtype=np.int32)
